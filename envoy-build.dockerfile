...
ADD --unpack=true https://github.com/pomerium/toolchain-utils/releases/download/${LLVM_VERSION}-${RELEASE_REVISION}/llvm-${LLVM_VERSION}-minimal-linux-${TARGETARCH}.tar.zst /
